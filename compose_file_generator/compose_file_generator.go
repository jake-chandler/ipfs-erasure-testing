...
type IpfsClusterPeerHelper struct {
	PeerNumber int
...
func New(peerNumber int, runenv *runtime.RunEnv, bootstrapId string) (*IpfsClusterPeerHelper, error) {
...
func (c *IpfsClusterPeerHelper) GenerateComposeFile() error {
...
func (c *IpfsClusterPeerHelper) GetPeerDockerDirectory() string {
	return fmt.Sprintf("peer%d", c.PeerNumber)
}

func (c *IpfsClusterPeerHelper) GetIpfsContainerName() string {
	return fmt.Sprintf("ipfs%d", c.PeerNumber)
}
func (c *IpfsClusterPeerHelper) GetClusterContainerName() string {
	return fmt.Sprintf("cluster%d", c.PeerNumber)
}
func (c *IpfsClusterPeerHelper) getAnyPort(base int) int {
...
func (c *IpfsClusterPeerHelper) GetPeerIpfsPort() int {
	return c.getAnyPort(5000)
}
func (c *IpfsClusterPeerHelper) GetPeerClusterPort() int {
	return c.getAnyPort(9000)
}
func (c *IpfsClusterPeerHelper) GetPeerGatewayPort() int {
	return c.getAnyPort(8000)
}
func (c *IpfsClusterPeerHelper) GetPeerSwarmPort() int {
...
func (c *IpfsClusterPeerHelper) writeToFile(content string) error {
...
func (c *IpfsClusterPeerHelper) TearDown() error {
...
func (c *IpfsClusterPeerHelper) LaunchNode() error {
...
func (c *IpfsClusterPeerHelper) StopNode() error {
...
func (c *IpfsClusterPeerHelper) StartNode() error {
...
func (c *IpfsClusterPeerHelper) GetFile(cid string) error {
	var ctlCmd *exec.Cmd
	if c.erasureEnabled {
	...
	timeout := 60 * 3
	_, err := executeCommandWithTimeout(ctlCmd, timeout, fmt.Errorf("timout retrieving file %s", cid))
	if err != nil {
		return err
	}
...
func (c *IpfsClusterPeerHelper) ClearIPFSCache() error {
...
func (c *IpfsClusterPeerHelper) PrintPinnedFiles(fileName string) error {
...
// AddFileToCluster adds a file to the IPFS cluster using ipfs-cluster-ctl.
// The 'filePath' parameter specifies the path of the file to add.
func (c *IpfsClusterPeerHelper) AddFileToCluster(filePath string) (*ECFile, error) {
	...
	return newECFileFromOutput(out), nil
}
